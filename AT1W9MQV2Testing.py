...
# set variables
bye=("Awww, we hate to see you go, thanks for playing MQ2!")
answer=''
ready=''
choice=''
bye=("Thanks for playing MQ2!!")

# collect student details/choices
...
while(True):
    try:
        ...
        print()
        exit=input("Press any key to play again or press n to exit game: ")
        if exit.lower() !='n': 
          ...
          sys.exit()
            ...
            print()
            print(" ** HMMM, MQ2 ONLY ACCEPTS NUMERIC VALUES FOR TIMES TABLES ** \n ")
